 ...
 */
package com.whl.mall.common.base.service.ext.impl;

/**
 * @Title: ShopRedisServiceImpl
...
public class MallRedisServiceImpl extends MallCacheServiceExt{
    ...
    @Override
    public int save(MallBasePoJo po) {
        return 0;
    }

    @Override
    public MallBasePoJo queryOne() {
        return null;
    }

    @Override
    public int delete(MallBasePoJo po) {
        return 0;
    }
