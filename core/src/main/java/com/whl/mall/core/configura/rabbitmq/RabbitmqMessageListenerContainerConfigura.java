...
public class RabbitmqMessageListenerContainerConfigura {
    ...
    public DirectMessageListenerContainer directMessageListenerContainer() {
        ...
        dmlc.setMessageListener(new RoleMessageListener());
    ...
    /**
     * 监听器API doc
     * @param memberMessageListener
     * 官网：https://docs.spring.io/spring-amqp/reference/htmlsingle/#containerAttributes
     * @return
     */
    @Deprecated
    public void apidDoc(MemberMessageListener memberMessageListener) {
        ...
        simpleMessageListenerContainer.setMessageListener(memberMessageListener);
    ...
    @Bean
    public MemberMessageListener memberMessageListener() {
        return new MemberMessageListener();
    }
