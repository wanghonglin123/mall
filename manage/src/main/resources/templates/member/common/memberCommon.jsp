...
<!--[if IE]> <script type="text/javascript" src="/resources/plugins/jquery-easyui-1.5.1/jquery.min.js?_v=${js$version}" ></script> <![endif]-->
<!--[if !IE]><!--> <script type="text/javascript" src="${static$domain}/js/common/jquery-3.0.0.min.js?_v=${js$version}" ></script>   <!--<![endif]-->
<!-- member 模块公共 -->
<!-- 公共css -->
...
<link rel="stylesheet" href="${static$domain}/style/common.css?_v=${css$version}"/>
<link rel="stylesheet" href="${static$domain}/style/main.css?_v=${css$version}"/>
<script type="text/javascript" src="${static$domain}/script/common.js?_v=${js$version}" ></script>
...
<script type="text/javascript" src="/resources/plugins/My97DatePicker/WdatePicker.js?_v=${js$version}"></script>
