...
<head>
    ...
    <title>洋桃跨境供应链后台管理中心-修改个人信息</title>
...
<section class="main" style="background-color: #fff;padding-top: 0px;">
...
<script type="text/javascript">
    ...
    /* 成员列表 -->编辑个人信息 objTable保存数据刷新列表对象 */
    function editFormInfo(objTable){
        if(!validateEdit()){
            return false;
        }
        // 获取资源组idx
