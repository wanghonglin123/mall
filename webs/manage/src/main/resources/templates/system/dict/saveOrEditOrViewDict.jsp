...
<div id="resourceCapacity" style="height: 366px;">
    <div class="winCont">
        <div class="winRow">
            <label class="brandName"><i>*</i>字典编码：</label>
            <input id="dictCode"  class="brandTxt required" type="text" value="${sysDataDictionary.dictCode}" ${(type eq 'view' or type eq 'edit') ? 'readonly="readonly"' :''} />
            <p class="palce-hint hint1">*字典编码必填</p>
        </div>
        <div class="winRow">
            <label class="brandName"><i>*</i>字典值：</label>
            <input id="dictKey" class="brandTxt required" type="text"
