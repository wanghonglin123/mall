...
<style type="text/css">
    .func-button{width: 60px;height: 22px;background:#ffac00;text-align:center;color: #fff;cursor: pointer;margin-top: 10px;}
</style>
<!--权限管理弹框 start-->
        ...
        <div class="authorityCont">
            <div class="contTop">
                ...
                <span class="qxMenu">
                    ...
                    <label class="lb" style="cursor: pointer;" id="button-all-checked-txt">全选</label><label class="lb">）</label>
                </span>
            </div>
            <div class="left-Menu">
...
<script type="text/javascript">
    ...
    /* objTable保存成功之后要刷新的数据的对象 */
    function saveMenuAndButton(objTable) {
