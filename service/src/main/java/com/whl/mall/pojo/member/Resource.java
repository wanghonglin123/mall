...
public class Resource extends AbstractMallBasePoJo {
    /**
     * 主键idx，分布式架构，全局唯一递增
     */
    private Long idx;
     ...
     * 资源组idxCode
     */
    private Long resourceGroupIdxCode;
     ...
     * 菜单或者按钮idxCode
     */
    private Long menuButtonIdxCode;
     ...
     * 资源组idxCode
     */
    public Long getResourceGroupIdxCode() {
        return resourceGroupIdxCode;
    }

    /**
     * 资源组idxCode
     */
    public void setResourceGroupIdxCode(Long resourceGroupIdxCode) {
        this.resourceGroupIdxCode = resourceGroupIdxCode;
    }
     ...
     * 菜单或者按钮idxCode
     */
    public Long getMenuButtonIdxCode() {
        return menuButtonIdxCode;
    }

    /**
     * 菜单或者按钮idxCode
     */
    public void setMenuButtonIdxCode(Long menuButtonIdxCode) {
        this.menuButtonIdxCode = menuButtonIdxCode;
    }
    ...
    public String toString() {
        ...
        sb.append(", resourceGroupIdxCode=").append(resourceGroupIdxCode);
        sb.append(", resourceType=").append(resourceType);
        sb.append(", menuButtonIdxCode=").append(menuButtonIdxCode);
