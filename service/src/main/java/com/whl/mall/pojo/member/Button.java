...
public class Button extends AbstractMallBasePoJo {
    /**
     * 主键idx，分布式架构，全局唯一递增
     */
    private Long idx;
     ...
     * 菜单idxCode
     */
    public void setMenuIdxCode(Long menuIdxCode) {
        this.menuIdxCode = menuIdxCode;
    }
    ...
    public String toString() {
        ...
        sb.append(", menuIdxCode=").append(menuIdxCode);
