...
import com.whl.mall.interfaces.member.ResourceService;
 ...
 */
@Service
public class ResourceServiceImpl extends MallServiceExt<Resource/*, MenuMapper*/> implements ResourceService {

    @Override
    public int saveResource(Resource pojo) throws MallException {
